...
public class Chess1 extends javax.swing.JFrame {
    ...
    public void tilePressed(int x, int y) {
        ...
        if (count == 1) {
            ...
            for (Piece z : whitePlayer){
                if (z.getX() == x && z.getY() == y) {
                    selectedPiece = z;
                    System.out.println(z.getX() + " a" + z.getY());
                    break;
                }
            }
        ...
        } else if (count == 2 && selectedPiece != null && selectedPiece.isLegalMove(this, x, y)) {
            stringToJButton.get("" + (char)(selectedPiece.getX()+64) + (selectedPiece.getY())).setIcon(null);
